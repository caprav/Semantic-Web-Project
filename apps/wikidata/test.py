...
def get_wikidata_qid(name):
    ...
    try:
        ...
        print(e,name,"Attempt 1 has failed")    
    ...
    if not processed_data['awards']:
        try:
            ...
            processed_data = process_data(results)
             ...
             print(e,name,"Attempt 2 has failed")  
        ...
        try: 
            ...
            if not processed_data['awards']:
                ...
                print(name,"Attempt 3 has failed", "register this")   
